...
public:
    PlayerHealthBar(std::shared_ptr<GameMediator> gameMediatorPtr, std::string newName, std::string barAssetDirectory, float posX, float posY, float scaleX, float scaleY);
